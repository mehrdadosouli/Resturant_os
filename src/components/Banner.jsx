          ...
          data.map(item =>
            <div key={item.id} className={`${styles.banner} px-5`}>
              <div className="w-1/2 bg-primary_blue_light_100 flex flex-col justify-between items-start rounded-l-3xl md:p-10 p-5">
                ...
                <div className="flex justify-center items-center lg:text-2xl lg:gap-5 lg:px-6 lg:py-5 md:text-xl md:px-4 md:py-3 md:gap-3 mt-2 rounded-3xl text-white bg-black">
                  <span className="md:text-3xl text-xl p-4">View Recipes</span>
